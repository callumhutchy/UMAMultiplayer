...
namespace Invector
{
    public static class vExtensions
    {
        ...
        public static HitBarPoints GetBoundPoint(this BoxCollider boxCollider,Transform torso, LayerMask mask)
        {
            ...
            Ray toBottom = new Ray(torso.position, boxPoint.botton - torso.position);
            ...
            dist = Vector3.Distance(torso.position, boxPoint.botton);
        ...
        public static BoxPoint GetBoxPoint(this BoxCollider boxCollider)
        {
            ...
            bp.botton = ray.GetPoint(-(height * 0.5f));
