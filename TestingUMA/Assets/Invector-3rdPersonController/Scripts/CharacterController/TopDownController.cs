...
namespace Invector.CharacterController
{
    ...
    public class TopDownController : ThirdPersonAnimator
    {
        ...
        void JumpInput()
        {
            ...
            bool jumpConditions = !crouch && onGround && !actions && staminaConditions;
            ...
            if (hitObject != null)
            {
                try
                {
                    if (hitObject.CompareTag("ClimbUp"))
                        ...
                        PickUpEquipment(hitObject, _input);
                }
        ...
        void PickUpEquipment(GameObject collectableItem, string _input)
        {
            if (Input.GetButtonDown(_input) && !actions)
            {
